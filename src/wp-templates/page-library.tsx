...
export default function Component(props: any) {
	...
	const [diagramImgUrl, setDiagramImgUrl] = useState('')

	function viewDiagram(diagramImgUrl: string) {
		setDiagramModalOpened(true)
		setDiagramImgUrl(diagramImgUrl)
	}
									...
									if (item.label == 'View the Library diagram') {
										return (
											<a
												...
												key={i}
												onClick={() =>
													viewDiagram(item.modalImage?.mediaItemUrl)
												}
											>
												{item.label}
											</a>
